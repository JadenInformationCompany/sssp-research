...
import com.szhis.frsoft.common.utils.StringUtils;
...
public class Cryptos {
	 ...
	 * java.lang.RuntimeException: java.security.NoSuchAlgorithmException: AES KeyGenerator not available
	 * eclipse运行java环境问题，没有找到相关类，在其他同事机器上运行没问题，后重装JAVA解决。
	 */
	...
	public static byte[] generateDesKey() {
		try {
			...
			//keyGenerator.init(56); DES  key size must be equal to 56
			SecretKey secretKey = keyGenerator.generateKey();
			return secretKey.getEncoded();
		} catch (GeneralSecurityException e) {
			throw Exceptions.unchecked(e);
